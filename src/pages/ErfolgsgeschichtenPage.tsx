...
const geschichten: Erfolgsgeschichte[] = [
  ...
  },
  {
    ...
    details:
      'Marcus erhielt eine Einladung zu einem Vorstellungsgespraech mit nur 2 Tagen Vorlauf. Der Termin lag 45 km entfernt, und Marcus hatte am selben Tag einen aertztlichen Termin, den er seit 3 Monaten wartete. Er informierte das Jobcenter vorab per E-Mail, wurde aber trotzdem mit 30% sanktioniert. Über den KI-Berater erfuhr Marcus, dass das Jobcenter einen wichtigen Grund nach § 31 Abs. 1 SGB II hätte prüfen muessen. Der Briefgenerator erstellte einen Widerspruch mit Verweis auf den aerztlichen Nachweis und die kurze Vorlauffrist. Die Sanktion wurde vollstaendig aufgehoben, und Marcus bekam 169 EUR zurück.',
    betragZurueck: 169,
    werkzeugGenutzt: ['KI-Berater', 'Briefgenerator', 'Sanktionsrechner'],
    datum: '2024-11',
    dauer: '5 Wochen',
    zitat:
      'Ich dachte, gegen das Jobcenter hat man sowieso keine Chance. Aber die KI hat mir genau gesagt, welche Paragraphen für mich sprechen.',
  },
  {
    id: 'ayse-mehrbedarf',
    name: 'Ayse K.',
  ...
  },
  {
    ...
    kurzfassung:
      'Thomas lebte allein, wurde aber in Regelbedarfsstufe 2 (Paare) eingestuft. Der BescheidScan fand den Fehler, den er selbst über ein Jahr übersehen hatte.',
    details:
      'Thomas war seit seiner Scheidung alleinstehend und lebte allein in seiner Wohnung. Das Jobcenter hatte ihn aber weiterhin in Regelbedarfsstufe 2 eingestuft, was dem Satz für Paare entspricht. Statt 563 EUR (Stufe 1) erhielt er nur 506 EUR monatlich. Als Thomas seinen Bescheid mit dem BescheidScan pruefte, wurde der Fehler sofort markiert. Mit dem Briefgenerator forderte er eine Überprüfung nach § 44 SGB X an - denn der Fehler bestand bereits seit 14 Monaten. Das Jobcenter korrigierte den Bescheid und zahlte 1.524 EUR Nachzahlung aus. Ab sofort erhaelt Thomas monatlich 57 EUR mehr.',
    betragZurueck: 1524,
    werkzeugGenutzt: ['BescheidScan', 'Briefgenerator', 'Bürgergeldrechner'],
    datum: '2024-12',
    dauer: '4 Wochen',
    zitat:
      'Ich habe über ein Jahr zu wenig Geld bekommen und es nicht gemerkt. Der BescheidScan hat den Fehler in 30 Sekunden gefunden.',
  },
  {
    ...
    titel: 'Baby-Erstausstattung doch bewilligt - 890 EUR für den Start',
    kurzfassung:
      'Sandras Antrag auf Erstausstattung für ihr erstes Kind wurde abgelehnt, weil sie angeblich schon Ausstattung habe. Der Widerspruch war erfolgreich.',
    details:
      'Sandra erwartete ihr erstes Kind und beantragte eine Erstausstattung nach § 24 Abs. 3 SGB II. Das Jobcenter lehnte ab mit der Begruendung, sie koenne gebrauchte Sachen nutzen. Sandra wusste nicht, dass dies kein zulaessiger Ablehnungsgrund ist. Der KI-Berater erklaerte ihr, dass bei einem ersten Kind ein Anspruch auf Erstausstattung besteht und das Jobcenter nicht auf gebrauchte Waren verweisen darf. Mit dem Briefgenerator erstellte sie einen ausfuehrlichen Widerspruch. Nach Prüfung bewilligte das Jobcenter die Erstausstattung in Höhe von 890 EUR, aufgeteilt in Bekleidungspauschale und Sachleistungen für Kinderwagen, Bett und Zubehoer.',
    betragZurueck: 890,
  ...
  },
  {
    ...
    details:
      'Elena arbeitete in einem Minijob für 520 EUR monatlich. Das Jobcenter rechnete den vollen Betrag auf ihr Bürgergeld an und zahlte entsprechend weniger aus. Der BescheidScan deckte den Fehler auf: Nach § 11b SGB II stehen Elena ein Grundfreibetrag von 100 EUR sowie 20% des Einkommens zwischen 100 und 520 EUR zu. Das sind 100 EUR plus 84 EUR, also 184 EUR Freibetrag. Elena hatte also Anspruch auf 184 EUR mehr pro Monat. Mit dem Freibetragsrechner berechnete sie die genaue Summe, und der Briefgenerator erstellte einen Ueberpruefungsantrag nach § 44 SGB X. Das Jobcenter korrigierte den Fehler rueckwirkend für 6 Monate: 1.104 EUR Nachzahlung.',
    betragZurueck: 1104,
    werkzeugGenutzt: ['BescheidScan', 'Freibetragsrechner', 'Briefgenerator'],
    datum: '2025-03',
    dauer: '3 Wochen',
    zitat:
      'Ich habe gearbeitet und trotzdem weniger Geld gehabt als mir zusteht. Ohne den BescheidBoxer hätte ich nie erfahren, was ein Freibetrag ist.',
  },
  {
  ...
  },
  {
    ...
    details:
      'Monikas Bewilligungszeitraum war für 6 Monate festgelegt, aber das Jobcenter hatte den Bedarf falsch berechnet: Ein Umzug innerhalb des Zeitraums wurde nicht beruecksichtigt, und die neuen, hoeheren Mietkosten wurden erst ab dem Folgezeitraum anerkannt. Ihr Widerspruch wurde abgelehnt. Der KI-Berater riet zur Klage und erklaerte die Voraussetzungen für Prozesskostenhilfe. Mit dem PKH-Rechner stellte Monika fest, dass sie Anspruch auf volle PKH hatte. Der Briefgenerator erstellte den PKH-Antrag und die Klageschrift. Das Sozialgericht gab ihr Recht: Das Jobcenter musste die hoeheren Mietkosten ab dem Umzugsmonat zahlen. Die Nachzahlung betrug 720 EUR für 4 Monate.',
    betragZurueck: 720,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
          <Card className="border-green-200 dark:border-green-800 bg-green-50/50 dark:bg-green-950/20">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-sm text-muted-foreground">zurückgeholt</div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-4 mb-12">
          ...
          {gefilterteGeschichten.length === 0 && (
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p>Keine Geschichten für diesen Filtertyp vorhanden.</p>
            </div>
          )}
        </div>
          ...
          <CardContent className="p-6 sm:p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                Jeder dieser Menschen hat sich getraut, seinen Bescheid zu prüfen. Mit den
