...
const articles: Article[] = [
  {
    ...
    description:
      'Die Grundsicherung nach SGB II einfach erklärt: Wer hat Anspruch, wie hoch sind die Regelsaetze 2025 und wie stellt man einen Antrag?',
    category: 'Grundlagen',
    readingTime: 8,
    icon: BookOpen,
    content: `Das Bürgergeld ist seit dem 1. Januar 2023 die Grundsicherung für erwerbsfaehige Leistungsberechtigte in Deutschland. Es hat das fruehere Arbeitslosengeld II ("Hartz IV") abgeloest und ist im Zweiten Buch Sozialgesetzbuch (SGB II) geregelt.
...
Wichtig: Stellen Sie den Antrag so frueh wie moeglich, auch wenn noch nicht alle Unterlagen vorliegen. Fehlende Unterlagen koennen nachgereicht werden.`,
    links: [
      { label: 'Zum Bürgergeld-Rechner', to: '/rechner/buergergeld' },
      { label: 'Zum KI-Berater', to: '/chat' },
    ],
  },
  {
    id: 'bescheid-fehler',
    title: 'Bescheid prüfen: Die 5 haeufigsten Fehler',
    description:
    ...
    readingTime: 10,
    icon: AlertTriangle,
    content: `Studien zeigen, dass etwa 40-50% aller Widersprüche und Klagen gegen Jobcenter-Bescheide erfolgreich sind. Die haeufigsten Fehler:

1. Falsche Berechnung der Kosten der Unterkunft (KdU)

Das Jobcenter kürzt haeufig die Mietkosten mit der Begruendung, sie seien "unangemessen". Pruefen Sie:
- Wurde die korrekte Mietobergrenze für Ihre Stadt angewandt?
...
- Mehrbedarf für Alleinerziehende (ss 21 Abs. 3 SGB II): 12-60% je nach Anzahl und Alter der Kinder
- Mehrbedarf für werdende Muetter ab der 13. Schwangerschaftswoche (ss 21 Abs. 2 SGB II): 17% des Regelsatzes
- Mehrbedarf bei kostenaufwaendiger Ernaehrung (ss 21 Abs. 5 SGB II), z.B. bei Diabetes, Zoeliakie
- Mehrbedarf für dezentrale Warmwassererzeugung (ss 21 Abs. 7 SGB II)
...
- Wurde das Schonvermögen korrekt berechnet (seit 2023: 40.000 EUR für die erste Person, 15.000 EUR für jede weitere, ss 12 Abs. 1 SGB II)?
- Wurde die Karenzzeit von 12 Monaten beruecksichtigt, in der Vermoegen gar nicht geprüft wird (ss 12 Abs. 3 SGB II)?
...
Tipp: Laden Sie Ihren Bescheid in unseren BescheidScan hoch - die KI findet diese Fehler automatisch.`,
  ...
  {
    id: 'widerspruch-schritt-für-schritt',
    title: 'Widerspruch einlegen Schritt für Schritt',
    description:
...
Beispiel: Bescheid abgeschickt am 10. Januar -> Zugang am 13. Januar -> Frist läuft bis 13. Februar.
...
- Die klare Erklärung "Hiermit lege ich Widerspruch ein"
...
- Per Post (Einschreiben empfohlen für Nachweis)
...
Schritt 5: Widerspruchsbescheid prüfen

Wenn der Widerspruch (ganz oder teilweise) abgelehnt wird, erhalten Sie einen Widerspruchsbescheid. Dagegen koennen Sie innerhalb von 1 Monat Klage beim Sozialgericht einreichen. Klagen im Sozialrecht sind für Leistungsempfaenger kostenfrei - es fallen keine Gerichtsgebuehren an (ss 183 SGG).

Wichtig: Der Widerspruch hat keine aufschiebende Wirkung (ss 86a Abs. 2 Nr. 4 SGG). Die Kürzung bleibt also zunaechst bestehen. Bei existenzbedrohenden Kürzungen koennen Sie beim Sozialgericht einen Eilantrag (einstweilige Anordnung nach ss 86b Abs. 2 SGG) stellen.`,
    links: [
  ...
  },
  {
    ...
    description:
      'Alles zu Miete und Heizung im Bürgergeld: Wann das Jobcenter die vollen Kosten zahlt, was "angemessen" bedeutet und was bei zu hoher Miete passiert.',
    category: 'Grundlagen',
    readingTime: 9,
    icon: Home,
    content: `Nach ss 22 Abs. 1 SGB II werden die tatsaechlichen Aufwendungen für Unterkunft und Heizung uebernommen, soweit sie angemessen sind.
...
Das Jobcenter erstellt ein "schluessiges Konzept" für die Mietobergrenze. Dieses muss sich an den oertlichen Verhaeltnissen orientieren. Orientierung bieten:
...
3. Erst danach darf das Jobcenter die Leistung auf die angemessene Höhe kürzen.

Wichtig: Es muss tatsaechlich angemessener Wohnraum verfuegbar sein! Wenn Sie trotz Bemühungen keine guenstigere Wohnung finden, muessen die hoeheren Kosten weiter uebernommen werden. Dokumentieren Sie Ihre Wohnungssuche (Bewerbungen, Absagen).
...
Vor einem Umzug sollten Sie die Zusicherung des Jobcenters einholen (ss 22 Abs. 6 SGB II). Dann werden auch Umzugskosten, Mietkaution (als Darlehen) und Maklergebuehren uebernommen.`,
  ...
  },
  {
    ...
    description:
      'Neben dem Regelsatz gibt es Mehrbedarfe für besondere Lebenslagen. Erfahren Sie, welche Mehrbedarfe es gibt und wie Sie diese beantragen.',
    category: 'Rechte',
    readingTime: 8,
    icon: Heart,
    content: `Mehrbedarfe nach ss 21 SGB II sind zusaetzliche Leistungen zum Regelbedarf für Personen in besonderen Lebenslagen. Sie muessen nicht gesondert beantragt werden, wenn dem Jobcenter die Umstaende bekannt sind - in der Praxis sollten Sie aber sicherheitshalber immer einen schriftlichen Antrag stellen.

Mehrbedarf für Schwangere (ss 21 Abs. 2 SGB II)
...
Mehrbedarf für Alleinerziehende (ss 21 Abs. 3 SGB II)

Abhaengig von Anzahl und Alter der Kinder:
- 1 Kind unter 7 Jahre: 36% des Regelsatzes (202,68 EUR)
- 1 Kind über 7 Jahre: 12% des Regelsatzes (67,56 EUR)
- 2 Kinder unter 16 Jahre: 36% (202,68 EUR)
- 2 Kinder, davon eins über 16: 24% (135,12 EUR)
- 3 Kinder: 36% (202,68 EUR)
- 4 Kinder: 48% (270,24 EUR)
- 5 oder mehr Kinder: 60% (337,80 EUR)
Maximum: 60% des Regelsatzes.

Mehrbedarf für Menschen mit Behinderung (ss 21 Abs. 4 SGB II)

35% des Regelsatzes (197,05 EUR) für Personen, die Leistungen zur Teilhabe am Arbeitsleben erhalten (z.B. in einer Werkstatt für behinderte Menschen oder bei einem anderen Leistungsanbieter) oder die einen Schwerbehindertenausweis mit Merkzeichen G oder aG besitzen.

Mehrbedarf für kostenaufwaendige Ernaehrung (ss 21 Abs. 5 SGB II)
...
- Kosten für Umgangsrecht mit Kindern (Fahrtkosten)`,
  ...
  },
  {
    ...
    description:
      'Was darf das Jobcenter kürzen, welche Grenzen hat das Bundesverfassungsgericht gesetzt und wie wehren Sie sich gegen unrechtmaessige Sanktionen?',
    category: 'Rechte',
    readingTime: 10,
    icon: Shield,
    content: `Sanktionen (offiziell "Leistungsminderungen" nach ss 31 ff. SGB II) sind Kürzungen des Bürgergeldes bei Pflichtverletzungen. Seit der Bürgergeld-Reform und dem Urteil des Bundesverfassungsgerichts (BVerfG, 05.11.2019, Az. 1 BvL 7/16) gelten strengere Regeln für das Jobcenter.
...
Höhe der Sanktionen (seit 01.01.2023):

- Erste Pflichtverletzung: 10% des Regelsatzes für 1 Monat
- Zweite Pflichtverletzung: 20% des Regelsatzes für 2 Monate
- Dritte und weitere: 30% des Regelsatzes für 3 Monate

Maximum: 30% des Regelsatzes. Hoehrere Kürzungen sind seit dem BVerfG-Urteil verfassungswidrig.

Bei Meldeversaeumnissen (ss 32 SGB II): 10% des Regelsatzes für 1 Monat.

Wichtig - das Existenzminimum ist geschuetzt:

Das BVerfG hat klargestellt: Das menschenwuerdige Existenzminimum darf nicht unterschritten werden. Kürzungen über 30% hinaus sind unzulaessig. Bei Haertefaellen kann die Sanktion ganz entfallen.
...
4. Eilantrag beim Sozialgericht: Bei existenzbedrohenden Kürzungen koennen Sie einen Eilantrag (einstweilige Anordnung, ss 86b Abs. 2 SGG) stellen.

5. Kürzung von KdU ist verboten: Kosten der Unterkunft duerfen durch Sanktionen nicht gekürzt werden - es droht sonst Obdachlosigkeit.

Tipp: Seit der Bürgergeld-Reform ist das Sanktionssystem deutlich milder geworden. Viele Sanktionen sind angreifbar. Legen Sie immer Widerspruch ein!`,
    links: [
  ...
  },
  {
    ...
    description:
      'Wie viel duerfen Sie verdienen, ohne dass das Bürgergeld gekürzt wird? Alle Freibetraege und Absetzbetraege im Überblick.',
    category: 'Grundlagen',
    readingTime: 7,
    icon: Euro,
    content: `Wenn Sie neben dem Bürgergeld arbeiten, wird nicht das gesamte Einkommen angerechnet. Es gibt Freibetraege nach ss 11b SGB II, die Ihnen erhalten bleiben.
...
Vom Bruttoeinkommen über 100 EUR bleiben zusaetzlich frei:
...
Hinweis: Die Berechnung erfolgt vom Bruttoeinkommen. Die tatsaechlichen Abzuege für Sozialversicherung und Steuern werden zusaetzlich abgesetzt (ss 11b Abs. 1 Nr. 1 und 2 SGB II). Der tatsaechlich angerechnete Betrag ist daher niedriger als das Brutto minus Freibetrag.
...
Wichtig: Jedes Einkommen muss dem Jobcenter gemeldet werden, auch wenn es unter dem Freibetrag liegt!`,
  ...
  {
    id: 'schonvermoegen',
    title: 'Schonvermögen: Was darfst du behalten?',
    description:
      'Seit der Bürgergeld-Reform gibt es deutlich hoehere Schonvermögen. Erfahren Sie, welches Vermoegen geschuetzt ist und was angerechnet wird.',
    category: 'Rechte',
    readingTime: 7,
    icon: Shield,
    content: `Beim Bürgergeld wird Vermoegen nur noch eingeschraenkt beruecksichtigt. Die Regeln wurden mit der Bürgergeld-Reform ab 2023 deutlich verbessert.

Karenzzeit (ss 12 Abs. 3 SGB II):

In den ersten 12 Monaten des Leistungsbezugs wird Vermoegen nicht beruecksichtigt, es sei denn, es ist "erheblich". Als erheblich gilt Vermoegen über:
- 40.000 EUR für die erste Person der Bedarfsgemeinschaft
...
Geschuetztes Vermoegen (Schonvermögen):
...
- Bei Ueberschreitung der Grenze um wenige Euro: Verbrauchen Sie das ueberschuessige Vermoegen für angemessene Anschaffungen vor Antragstellung.`,
    links: [
      { label: 'Zum Schonvermögen-Rechner', to: '/rechner/schonvermoegen' },
      { label: 'Zum KI-Berater', to: '/chat' },
    ],
  },
  {
    ...
    description:
      'Seit dem Bürgergeld heisst sie "Kooperationsplan". Was Sie unterschreiben muessen, was nicht, und wie Sie Ihre Rechte wahren.',
    category: 'Tipps',
    readingTime: 8,
    icon: FileText,
    content: `Die fruehere Eingliederungsvereinbarung (EGV) wurde mit dem Bürgergeld durch den Kooperationsplan (ss 15 SGB II) ersetzt. Dieser soll gemeinsam und auf Augenhoehe erstellt werden.
...
- Sie muessen nichts unterschreiben, was Sie für unzumutbar halten.
...
- Bitten Sie um schriftliche Bestaetigung von Zusagen.`,
  ...
  },
  {
    ...
    readingTime: 6,
    icon: Home,
    content: `Nach ss 24 Abs. 3 SGB II koennen Sie Leistungen für Erstausstattungen als einmalige Bedarfe beantragen. Diese sind nicht im Regelsatz enthalten und werden zusaetzlich gewaehrt.

Arten der Erstausstattung:

1. Erstausstattung für die Wohnung (ss 24 Abs. 3 Nr. 1 SGB II):
...
2. Erstausstattung für Bekleidung (ss 24 Abs. 3 Nr. 2 SGB II):
...
Die meisten Jobcenter zahlen Pauschalen aus. Die Höhe variiert je nach Kommune. Manche Jobcenter bieten auch Gutscheine oder verweisen auf Moebelkammern. Sie haben grundsaetzlich das Recht, die Pauschale als Geldleistung zu erhalten.
...
Tipp: Stellen Sie den Antrag fruehzeitig, besonders bei Schwangerschaft. Die Bearbeitung kann mehrere Wochen dauern.`,
  ...
  },
  {
    ...
    description:
      'Wer kein Geld für einen Anwalt hat, kann Prozesskostenhilfe beantragen. So funktioniert PKH beim Sozialgericht.',
    category: 'Tipps',
    readingTime: 7,
    icon: Scale,
    content: `Prozesskostenhilfe (PKH) nach ss 73a SGG i.V.m. ss 114 ff. ZPO ermoeglicht es Ihnen, einen Rechtsanwalt zu beauftragen, ohne die Kosten selbst tragen zu muessen. Als Bürgergeld-Empfaenger haben Sie in der Regel Anspruch auf PKH.

Voraussetzungen:

1. Beduerfigkeit: Sie koennen die Kosten nicht selbst tragen. Als Bürgergeld-Empfaenger ist diese Voraussetzung praktisch immer erfuellt.
2. Erfolgsaussicht: Die beabsichtigte Klage muss hinreichende Aussicht auf Erfolg haben. Das Gericht prüft dies summarisch.
3. Keine Mutwilligkeit: Die Rechtsverfolgung darf nicht mutwillig sein.

Besonderheit im Sozialrecht:

Klagen beim Sozialgericht sind für Leistungsempfaenger immer gerichtkostenfrei (ss 183 SGG). PKH brauchen Sie also nur, wenn Sie einen Anwalt beauftragen moechten. Grundsaetzlich koennen Sie auch ohne Anwalt klagen - das Sozialgericht hat eine Amtsermittlungspflicht.

Antragstellung:

1. Der PKH-Antrag wird beim Sozialgericht gestellt, bei dem die Klage erhoben werden soll.
2. Verwenden Sie das amtliche Formular "Erklärung über die persoenlichen und wirtschaftlichen Verhaeltnisse" (erhaeltlich beim Gericht oder online).
3. Fuegen Sie bei: aktueller Bürgergeld-Bescheid, Kontoauszuege der letzten 3 Monate, Mietvertrag.
...
Rueckzahlung: Bei PKH ohne Ratenzahlung (was als Bürgergeld-Empfaenger der Regelfall ist) muessen Sie nichts zurueckzahlen, auch wenn Sie den Prozess verlieren.
...
Fuer die aussergerichtliche Beratung (z.B. Widerspruchsverfahren) gibt es die Beratungshilfe nach dem Beratungshilfegesetz. Beantragen Sie einen Beratungshilfeschein beim Amtsgericht (Gebuehr: 15 EUR, die auch erlassen werden kann).`,
  ...
  },
  {
    ...
    description:
      'Das Jobcenter verlangt vieles - aber nicht alles muessen Sie sich gefallen lassen. Überblick über Pflichten und deren Grenzen.',
    category: 'Rechte',
    readingTime: 9,
    icon: Users,
    content: `Als Bürgergeld-Empfaenger haben Sie Mitwirkungspflichten (ss 60 ff. SGB I und ss 31 ff. SGB II). Diese sind aber nicht grenzenlos.
...
2. Mitwirkung bei der Vermittlung (ss 2 SGB II):
   - Aktive Eigenbemühungen bei der Arbeitssuche
...
- Ihre Wohnung aufgeben für einen Job in einer anderen Stadt (in den ersten 6 Monaten)
        ...
        <Card className="bg-gradient-boxer text-white mt-12">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-white/90 mb-6 max-w-xl mx-auto">
              Stellen Sie Ihre individuelle Frage zu Bürgergeld, Bescheiden
              oder Widersprüchen - rund um die Uhr, kostenlos im Basis-Tarif.
            </p>
